class Main extends React.Component {
    ...
    componentDidMount() {
        ...
        APP.proposal.viewPlan(this.state.planId, plan => {
            APP.proposal.listRiders(this.state.planId, localStorage.channelId,localStorage.orgId,localStorage.mainProductId,this.state.index, r => {
                r.map(v => {
                    let prdForm = {
                        name: v.name,
                        productId: v.code,
                    ...
                    plan.product.map((r3, i) => {
                        if (r3.productId == v.code && r3.parent == this.state.index) {
                            APP.proposal.editProduct(this.state.planId, localStorage.channelId,localStorage.orgId,localStorage.mainProductId,i, r4 => {
