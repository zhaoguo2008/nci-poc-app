...
const serverUrl = 'http://114.112.96.30:10003/';
            ...
            <div className="home-container">
                ...
                <div className="shortcut-row2">
                    ...
                    <div className="sr2-right">
                        <a class="sr2-top" onClick={this.toFunPage.bind(this,'productIntroduction')}>
                            ...
                            this.state.products.map(prod=>{
                                return (
                                    <a className="prod-item"onClick={this.productDetail.bind(this,prod)}>
                                        <img src={ prod.cover ? (serverUrl + "nic/"+ prod.cover) :  "../images/home/default_img.png"}/>
                                        <i>{prod.title}</i>
                                    </a>
                                )
                            })
