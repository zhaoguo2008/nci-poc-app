    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var Main = function (_React$Component) {
            ...
            _createClass(Main, [{
                ...
                value: function next() {
                    this.save();
                    alert(JSON.stringify(localStorage.insurantsCardData));
                ...
                value: function render() {
                    ...
                    return React.createElement(
                        ...
                        React.createElement(
                            "div",
                            { className: "bg-desk", style: { display: "flex", position: "fixed", zIndex: "50", top: "0" } },
                            ...
                            this.state.cust.length >= 3 ? null : React.createElement(
                                "div",
                                { style: { width: 750 - 250 * this.state.cust.length + "px", height: "80px", textAlign: "right" } },
                        ...
                        React.createElement(
                            "div",
                            { style: { backgroundColor: "#ff3333", borderRadius: "10px", margin: "20px", lineHeight: "70px", height: "70px", width: "710px", textAlign: "center", color: "#ffffff" }, onClick: this.deleteInsurant.bind(this) },
                            "\u5220\u9664"
                        ),
