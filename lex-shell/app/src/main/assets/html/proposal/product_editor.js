            ...
            if (riderForm.form == null) {
                APP.proposal.addProduct(this.state.planId, this.state.index, productId, function (r) {
                    r.product.map(function (r2, i) {
                        if (r2.productId == productId && r2.parent == _this3.state.index) APP.proposal.editProduct(_this3.state.planId,localStorage.channelId,localStorage.orgId,productId, i, function (r1) {
