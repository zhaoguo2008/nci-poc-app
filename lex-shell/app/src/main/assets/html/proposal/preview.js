...
var Main = function (_React$Component) {
    ...
    _createClass(Main, [{
        ...
        key: "showCoverageDetail",
        value: function showCoverageDetail(i, j) {
            ...
            return React.createElement(
                ...
                React.createElement(
                                ...
                                v.detail.map(function (w, j) {
                                    return React.createElement(
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                "div",
                                                { className: "mt-1 mb-1 lh-40 center bg-primary tc-white", style: { width: "40px", borderRadius: "20px" } },
                                                j + 1
                                            ),
                                            React.createElement(
                                                "div",
                                                { className: "ml-1 lh-60 tc-primary" },
                                                w.name
                                            )
                                        ),
                        ...
                        !this.state.chart ? null : this.state.chart.map(function (v, i) {
                            return !v.content ? null : React.createElement(
                                ...
                                React.createElement(
                                    "div",
                                    { className: "divx" },
                                    React.createElement(_benefit_chart2.default, { size: 750, ref: "benefitChart" + i, id: "benefitChart" + i, chart: v, years: [-2, -1, 0, 1, 2] })
                                )
                            );
                        })
                    ),
                    ...
                    React.createElement(
                        "div",
                        { className: "ml-1 mr-1 pt-2 pb-2 bg-white", style: { border: "#dddddd 1px solid" } },
                        !this.state.coverage ? null : this.state.coverage.map(function (v, i) {
                            return React.createElement(
                                "div",
                                ...
                                v.content.map(function (x, j) {
                                    return React.createElement(
                                        ...
                                        React.createElement(
                                            "div",
                                            { className: "divx h-60", onClick: _this4.showCoverageDetail.bind(_this4, i, j) },
                                            React.createElement(
                                                "div",
                                                { className: "text17 mt-1 mb-1 lh-40 center bg-primary tc-white", style: { width: "40px", borderRadius: "20px" } },
                                                j + 1
                                            ),
                                            React.createElement(
                                                "div",
                                                { className: "text17 ml-1 lh-60 tc-primary" },
                                                x.title
                                            ),
                                            React.createElement(
                                                "div",
                                                { className: "ml-auto mr-1 pt-1 pm-1" },
                                                React.createElement("img", { style: { width: "40px", height: "40px" }, src: x.show ? "../images/arrow-7-up.png" : "../images/arrow-7-down.png" })
                                            )
                                        ),
